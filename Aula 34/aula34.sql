...
insert into cliente values (24,'Crisberliston','15935745698','2000-01-01',1);
insert into cliente values (25,'Malgamorson','32165498700','2001-01-01',1);
insert into cliente values (26,'Silmastilda','12345678900','2002-01-01',1);
insert into cliente values (27,'Florasmirtes','14785236911','2003-01-01',1);
...
where exists (select * from venda v where v.i_cliente_cliente = c.i_cliente_cliente);